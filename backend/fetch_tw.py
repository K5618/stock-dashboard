# fetch_tw.py
import os
from src.services.tw_aggregator import TaiwanDataAggregator
...
def main():
    ...
    # Generate data
    aggregator = TaiwanDataAggregator()
    ...
    gc_limit = int(os.environ.get("TW_SNAPSHOTS_LIMIT", 2))
    
    # Store data
    db = SupabaseManager()
    db.upsert_snapshot("tw_market_snapshots", validated_payload, limit=gc_limit)
